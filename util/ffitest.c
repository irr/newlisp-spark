...
/*
 ...
 this file is used in qa/qa-specific-tests/qa-libffi

 compile using either:
     gcc -m32 ffitest.c -shared -o ffitest.so
 or
     gcc -m64 ffitest.c -shared -o ffitest.so
...
(import "ffitest.so" "mixed_int_float")
