...
#
# USAGE: sb2 make -f makefiles/raspberrypi.mk
...
CFLAGS = -mcpu=arm1176jzf-s -Wall -pedantic -Wno-strict-aliasing -Wno-long-long -c -O3 -g -DLINUX -Ipcre
#CFLAGS = -mcpu=arm1176jzf-s -Wall -pedantic -Wno-strict-aliasing -Wno-long-long -c -O3 -g -DLINUX -DREADLINE
