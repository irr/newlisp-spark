...
CFLAGS = -fPIC -m64 -Wall -Wno-uninitialized -Wno-strict-aliasing -Wno-long-long -c -O3 -g -DREADLINE -DSUPPORT_UTF8 -DNEWLISP64 -DLINUX -Ipcre
...
$(OBJS): primes.h protos.h newlisp.h nl-vm.h makefiles/linuxLP64_utf8.mk
