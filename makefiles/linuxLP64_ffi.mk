...
CFLAGS = -fPIC -m64 -Wall -Wno-uninitialized -Wno-strict-aliasing -Wno-long-long -c -O3 -g -DREADLINE -DNEWLISP64 -DLINUX -DFFI -I/usr/local/lib/libffi-3.0.13/include  -Ipcre
...
$(OBJS): primes.h protos.h newlisp.h nl-vm.h makefiles/linuxLP64_ffi.mk
